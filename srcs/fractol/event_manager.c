...
/*   Updated: 2020/02/07 15:54:59 by dapinto          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_event	*fetchevent(void)
{
	...
	if (!holder[0])
	{
		...
		store_event(&holder[116], &ft_zoom, 1);
		store_event(&holder[121], &ft_zoom, 1);
	}
	return (holder);
}
...
{
	if (k == 53 || k == 123 || k == 124 || k == 125 || k == 126 || k == 116
			|| k == 121 || k == 115 || k == 82 || k == 83 || k == 84 || k == 85
